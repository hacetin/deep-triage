...
from dataset import google_chromium_chronological_cv, mozilla_core_chronological_cv, mozilla_firefox_chronological_cv
...
def dnrnna_model(input_shape, num_output, num_lstm_unit=512, num_dense_unit=1000):
    ...
    backwards_1 = LSTM(num_lstm_unit, return_sequences=True, dropout=0.2, go_backwards=True)(input_1)
